 ...
 ******************************************************************************/
package cpw.mods.ironchest.gui.barrel;
...
public class ContainerIronBarrel extends Container {
    ...
    public ContainerIronBarrel(IInventory playerInventory, IInventory chestInventory, IronBarrelType type, int xSize,
            int ySize) {
    ...
    protected void layoutContainer(IInventory playerInventory, IInventory chestInventory, IronBarrelType type,
            int xSize, int ySize) {
