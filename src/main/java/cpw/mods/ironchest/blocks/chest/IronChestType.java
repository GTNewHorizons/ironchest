 ...
 ******************************************************************************/
package cpw.mods.ironchest.blocks.chest;
...
import cpw.mods.ironchest.compat.Mods;
import cpw.mods.ironchest.gui.chest.slot.ValidatingChestSlot;
import cpw.mods.ironchest.tileentity.chest.TileEntityCopperChest;
import cpw.mods.ironchest.tileentity.chest.TileEntityCrystalChest;
import cpw.mods.ironchest.tileentity.chest.TileEntityDarkSteelChest;
import cpw.mods.ironchest.tileentity.chest.TileEntityDiamondChest;
import cpw.mods.ironchest.tileentity.chest.TileEntityDirtChest;
import cpw.mods.ironchest.tileentity.chest.TileEntityGoldChest;
import cpw.mods.ironchest.tileentity.chest.TileEntityIronChest;
import cpw.mods.ironchest.tileentity.chest.TileEntityNetheriteChest;
import cpw.mods.ironchest.tileentity.chest.TileEntityObsidianChest;
import cpw.mods.ironchest.tileentity.chest.TileEntitySilverChest;
import cpw.mods.ironchest.tileentity.chest.TileEntitySteelChest;
        ...
        if (isValidForCreativeMode()) {
            ...
            for (String s : sideNames) {
                if (name().equalsIgnoreCase("steel")) {
                    icons[i++] = par1IconRegister.registerIcon(String.format("ironchest:chest_silver_%s", s));
                } else {
                    icons[i++] = par1IconRegister
                            .registerIcon(String.format("ironchest:chest_%s_%s", name().toLowerCase(), s));
                }
            }
        }
    }
