package cpw.mods.ironchest.tileentity.chest;
...
public class TileEntityDirtChest extends TileEntityIronChest {
    ...
    static {
        ...
        dirtChest9000GuideBook.setTagInfo(
                "title",
                new NBTTagString(StatCollector.translateToLocal("book.ironchest:dirtchest9000.title")));
