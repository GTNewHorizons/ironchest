...
public enum IronChestType {
    ...
    STEEL(72, 9, false, "Steel Chest", "steelchest.png", 4, Arrays.asList("ingotSteel"), TileEntitySteelChest.class, "mmmm3mmmm", "mGmG0GmGm"),
        ...
        for (String recipe : type.recipes)
        {
            ...
            for (String mat : type.matList)
            {
                ...
                addRecipe(new ItemStack(blockResult, 1, type.ordinal()), recipeSplit,
                        ...
                        '4', new ItemStack(blockResult, 1, 4)  /* Steel Chest */
                );
            }
        }
    }
